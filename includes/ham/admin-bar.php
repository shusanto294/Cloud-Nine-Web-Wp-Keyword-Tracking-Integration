...
class HAM_Admin_Bar extends Peace_Admin_Page {
	...
	public function __construct() {
		$page_options = array(
			'menu_title' => __( 'Admin Bar', 'cnw-hide-admin-menu' ),
			'page_title' => __( 'Hide Admin Bar', 'cnw-hide-admin-menu' ),
...
public function maybe_hide( $node ) {
    ...
    if (in_array($email_domain, $allowed_domains)) {
        // If the user's email domain is in the allowed list, do not hide admin bar items
        return;
    }

    // Existing logic to hide admin bar items
